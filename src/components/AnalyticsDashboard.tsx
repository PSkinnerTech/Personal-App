    ...
    <div className='flex flex-col gap-6'>
      <div className='grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6'>
        <Card className='w-full'>
          <p className='text-tremor-default text-dynamic-dark'>
            Avg. visitors/day
          </p>
          <p className='text-3xl text-dynamic-dark font-semibold'>
            {avgVisitorsPerDay}
          </p>
        </Card>
        <Card className='w-full'>
          <p className='flex gap-2.5 items-center text-tremor-default text-dynamic-dark'>
            Visitors today
            <Badge
              percentage={
      ...
      <Card className='flex flex-col sm:grid grid-cols-4 gap-6'>
        <h2 className='w-full text-tremor-default text-dynamic-dark text-center sm:left-left font-semibold text-xl'>
